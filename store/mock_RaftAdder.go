...
func (_m *MockRaftAdder) BootstrapCluster(conf raft.Configuration, partition uint32) raft.Future {
	...
	var r0 raft.Future
	if rf, ok := ret.Get(0).(func(raft.Configuration, uint32) raft.Future); ok {
...
func (_m *MockRaftAdder) Leader(id uint32) bool {
	ret := _m.Called(id)
