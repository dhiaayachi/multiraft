...
func (_m *MockRaftTransport) AppendEntries(id raft.ServerID, target raft.ServerAddress, args *raft.AppendEntriesRequest, resp *raft.AppendEntriesResponse) error {
...
func (_m *MockRaftTransport) AppendEntriesPipeline(id raft.ServerID, target raft.ServerAddress) (raft.AppendPipeline, error) {
...
func (_m *MockRaftTransport) Close() error {
	ret := _m.Called()
...
func (_m *MockRaftTransport) Consumer() <-chan raft.RPC {
	ret := _m.Called()
...
func (_m *MockRaftTransport) DecodePeer(_a0 []byte) raft.ServerAddress {
	ret := _m.Called(_a0)
...
func (_m *MockRaftTransport) EncodePeer(id raft.ServerID, addr raft.ServerAddress) []byte {
...
func (_m *MockRaftTransport) InstallSnapshot(id raft.ServerID, target raft.ServerAddress, args *raft.InstallSnapshotRequest, resp *raft.InstallSnapshotResponse, data io.Reader) error {
...
func (_m *MockRaftTransport) LocalAddr() raft.ServerAddress {
	ret := _m.Called()
...
func (_m *MockRaftTransport) RequestPreVote(id raft.ServerID, target raft.ServerAddress, args *raft.RequestPreVoteRequest, resp *raft.RequestPreVoteResponse) error {
	ret := _m.Called(id, target, args, resp)
...
func (_m *MockRaftTransport) RequestVote(id raft.ServerID, target raft.ServerAddress, args *raft.RequestVoteRequest, resp *raft.RequestVoteResponse) error {
	ret := _m.Called(id, target, args, resp)
...
func (_m *MockRaftTransport) SetHeartbeatHandler(cb func(raft.RPC)) {
	_m.Called(cb)
}

// TimeoutNow provides a mock function with given fields: id, target, args, resp
func (_m *MockRaftTransport) TimeoutNow(id raft.ServerID, target raft.ServerAddress, args *raft.TimeoutNowRequest, resp *raft.TimeoutNowResponse) error {
	ret := _m.Called(id, target, args, resp)
...
// NewMockRaftTransport creates a new instance of MockRaftTransport. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockRaftTransport(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockRaftTransport {
